...
function fnAgregarInfo() {
    ...
    document.querySelector("#agregarInfo").style.display = "none";
    localStorage.setItem("InformacionDelUsuario", parrafo);
}

function cargarInformacion() {
    if (localStorage.getItem("InformacionDelUsuario") != null) {
        var info = document.querySelector("#info");
        var obtenerInformacion = localStorage.getItem("InformacionDelUsuario");
        info.innerHTML = "<p>" + obtenerInformacion + "</p>";
        document.querySelector("#agregarInfo").style.display = "none";
    }
}